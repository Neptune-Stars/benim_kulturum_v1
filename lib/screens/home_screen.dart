    ...
    return SafeArea(
      child: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot) {
            ...
            final announcements = (data['announcements'] as List<dynamic>? ?? []).take(2).toList();
            final events = (data['events'] as List<dynamic>? ?? []).take(2).toList();
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const InfoCard(
                          ...
                          badge: AppBadge(label: "₺35", backgroundColor: AppTheme.successColor, textColor: Colors.white),
                          showChevron: false,
                        ),
                        const SizedBox(height: 16),
                        ...
                        ...announcements.map((a) => InfoCard(
                          title: a['title'] ?? '',
                          subtitle: a['date'] ?? '',
                          badge: (a['isNew'] == true) ? const AppBadge(label: "Yeni", backgroundColor: AppTheme.primaryColor, textColor: Colors.white) : null,
                          showChevron: false,
                        )),
